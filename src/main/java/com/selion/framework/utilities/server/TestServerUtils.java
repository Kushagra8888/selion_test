...
package com.selion.framework.utilities.server;
...
import com.selion.framework.logging.AppLogger;
...
public class TestServerUtils {
    ...
    private static String CONTROL_LOGIN = "/login.html";
    private static String CONTROL_BOARD = "/dashboard.html";
